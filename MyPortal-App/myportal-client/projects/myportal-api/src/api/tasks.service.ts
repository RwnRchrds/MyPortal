...
import { TaskToggleRequestModel } from '../model/taskToggleRequestModel';
...
export class TasksService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public toggleCompleted(body?: TaskToggleRequestModel, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public toggleCompleted(body?: TaskToggleRequestModel, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public toggleCompleted(body?: TaskToggleRequestModel, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public toggleCompleted(body?: TaskToggleRequestModel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateForm(id?: string, typeId?: string, title?: string, description?: string, dueDate?: Date, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateForm(id?: string, typeId?: string, title?: string, description?: string, dueDate?: Date, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateForm(id?: string, typeId?: string, title?: string, description?: string, dueDate?: Date, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateForm(id?: string, typeId?: string, title?: string, description?: string, dueDate?: Date, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
