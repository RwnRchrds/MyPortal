...
export class DocumentsService {
     ...
     */
    public _delete(documentId?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public _delete(documentId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public _delete(documentId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public _delete(documentId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/api/documents/delete`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public create(body?: CreateDocumentModel, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public create(body?: CreateDocumentModel, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public create(body?: CreateDocumentModel, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public create(body?: CreateDocumentModel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/documents/create`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public downloadFile(documentId: string, observe?: 'body', reportProgress?: boolean): Observable<Stream>;
    public downloadFile(documentId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Stream>>;
    public downloadFile(documentId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Stream>>;
    public downloadFile(documentId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Stream>('get',`${this.basePath}/api/documents/file/${encodeURIComponent(String(documentId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getById(documentId?: string, observe?: 'body', reportProgress?: boolean): Observable<DocumentModel>;
    public getById(documentId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DocumentModel>>;
    public getById(documentId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DocumentModel>>;
    public getById(documentId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<DocumentModel>('get',`${this.basePath}/api/documents/get`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getWebViewLink(documentId?: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public getWebViewLink(documentId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public getWebViewLink(documentId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public getWebViewLink(documentId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('get',`${this.basePath}/api/documents/view`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public update(body?: UpdateDocumentModel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
