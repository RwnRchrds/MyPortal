...
import { StudentStatsModel } from '../model/studentStatsModel';
...
export class StudentsService {
     ...
     */
    public getById(studentId?: string, observe?: 'body', reportProgress?: boolean): Observable<StudentModel>;
    public getById(studentId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StudentModel>>;
    public getById(studentId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StudentModel>>;
    public getById(studentId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<StudentModel>('get',`${this.basePath}/api/students/id`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getStatsById(studentId?: string, academicYearId?: string, observe?: 'body', reportProgress?: boolean): Observable<StudentStatsModel>;
    public getStatsById(studentId?: string, academicYearId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StudentStatsModel>>;
    public getStatsById(studentId?: string, academicYearId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StudentStatsModel>>;
    public getStatsById(studentId?: string, academicYearId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<StudentStatsModel>('get',`${this.basePath}/api/students/stats`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
