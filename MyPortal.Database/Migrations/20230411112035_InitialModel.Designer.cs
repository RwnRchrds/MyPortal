...
namespace MyPortal.Database.Migrations
{
    ...
    [Migration("20230411112035_InitialModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.CurriculumGroupSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("CurriculumGroupSessions");
                });
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.ParentEveningAppointment", b =>
                {
                    ...
                    b.Property<bool>("ParentAccepted")
                        .HasColumnType("bit")
                        .HasColumnOrder(7);
                    ...
                    b.Property<bool>("TeacherAccepted")
                        .HasColumnType("bit")
                        .HasColumnOrder(6);
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.SenReview", b =>
                {
                    ...
                    b.Property<Guid?>("OutcomeSenStatusId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(7);
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.SenReviewStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.SessionExtraName", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("SessionExtraNames");
                });

            modelBuilder.Entity("MyPortal.Database.Models.Entity.SessionPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("SessionPeriods");
                });

            modelBuilder.Entity("MyPortal.Database.Models.Entity.SessionType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.TaskReminder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.UserReminderSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<TimeSpan>("RemindBefore")
                        .HasColumnType("time")
                        .HasColumnOrder(4);

                    b.Property<Guid>("ReminderType")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(3);
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.CurriculumGroupSession", b =>
                {
                    b.HasOne("MyPortal.Database.Models.Entity.CurriculumGroup", "CurriculumGroup")
                        .WithMany("CurriculumGroupSessions")
                        .HasForeignKey("CurriculumGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyPortal.Database.Models.Entity.SessionType", "SessionType")
                        .WithMany("CurriculumGroupSessions")
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.SenReview", b =>
                {
                    ...
                    b.HasOne("MyPortal.Database.Models.Entity.SenStatus", "OutcomeStatus")
                        .WithMany("SenReviews")
                        .HasForeignKey("OutcomeSenStatusId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MyPortal.Database.Models.Entity.SenReviewStatus", "ReviewStatus")
                        .WithMany("SenReviews")
                    ...
                    b.HasOne("MyPortal.Database.Models.Entity.StaffMember", "Senco")
                        .WithMany("SenReviews")
                        .HasForeignKey("SencoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.AttendanceWeek", b =>
                {
                    ...
                    b.Navigation("SessionExtraNames");
                });
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.CurriculumGroup", b =>
                {
                    ...
                    b.Navigation("CurriculumGroupSessions");
                });
            ...
            modelBuilder.Entity("MyPortal.Database.Models.Entity.User", b =>
                {
                    ...
                    b.Navigation("UserReminderSettings");
