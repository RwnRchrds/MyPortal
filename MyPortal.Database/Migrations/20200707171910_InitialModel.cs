    ...
    public partial class InitialModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurriculumBlock", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogNoteType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomClosureReason", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffAbsenceType", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "StaffIllnessType",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false, defaultValueSql: "NEWSEQUENTIALID()"),
                    Description = table.Column<string>(maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffIllnessType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AcademicYear_SelectedAcademicYearId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceWeekPattern_AcademicYear_AcademicYearId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurriculumGroup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurriculumGroup_CurriculumBlock_BlockId",
                        column: x => x.BlockId,
                        principalTable: "CurriculumBlock",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurriculumBand_CurriculumYearGroup_CurriculumYearGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LegalFirstName = table.Column<string>(maxLength: 256, nullable: true),
                    LegalLastName = table.Column<string>(maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurriculumBandBlock", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurriculumBandBlock_CurriculumBand_BandId",
                        column: x => x.BandId,
                        principalTable: "CurriculumBand",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CurriculumBandBlock_CurriculumBlock_BlockId",
                        column: x => x.BlockId,
                        principalTable: "CurriculumBlock",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DiaryEvent_Room_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Room",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomClosure", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomClosure_RoomClosureReason_ReasonId",
                        column: x => x.ReasonId,
                        principalTable: "RoomClosureReason",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomClosure_Room_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Room",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Task_AspNetUsers_AssignedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffAbsence_StaffAbsenceType_AbsenceTypeId",
                        column: x => x.AbsenceTypeId,
                        principalTable: "StaffAbsenceType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StaffAbsence_StaffIllnessType_IllnessTypeId",
                        column: x => x.IllnessTypeId,
                        principalTable: "StaffIllnessType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StaffAbsence_StaffMember_StaffMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Class_CurriculumGroup_GroupId",
                        column: x => x.GroupId,
                        principalTable: "CurriculumGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cover_Room_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Room",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cover_Session_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Session",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cover_StaffMember_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "StaffMember",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cover_AttendanceWeek_WeekId",
                        column: x => x.WeekId,
            ...
            migrationBuilder.CreateTable(
                name: "CurriculumGroupMembership",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false, defaultValueSql: "NEWSEQUENTIALID()"),
                    StudentId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurriculumGroupMembership", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CurriculumGroupMembership_CurriculumGroup_GroupId",
                        column: x => x.GroupId,
                        principalTable: "CurriculumGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CurriculumGroupMembership_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeworkSubmission_Document_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogNote", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogNote_AcademicYear_AcademicYearId",
                        column: x => x.AcademicYearId,
                        principalTable: "AcademicYear",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LogNote_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceWeekPattern_AcademicYearId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cover_RoomId",
                table: "Cover",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Cover_SessionId",
                table: "Cover",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_Cover_TeacherId",
                table: "Cover",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_Cover_WeekId",
                table: "Cover",
                column: "WeekId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumBand_CurriculumYearGroupId",
                table: "CurriculumBand",
                column: "CurriculumYearGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumBandBlock_BandId",
                table: "CurriculumBandBlock",
                column: "BandId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumBandBlock_BlockId",
                table: "CurriculumBandBlock",
                column: "BlockId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumGroup_BlockId",
                table: "CurriculumGroup",
                column: "BlockId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumGroupMembership_GroupId",
                table: "CurriculumGroupMembership",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumGroupMembership_StudentId",
                table: "CurriculumGroupMembership",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkSubmission_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogNote_AcademicYearId",
                table: "LogNote",
                column: "AcademicYearId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomClosure_ReasonId",
                table: "RoomClosure",
                column: "ReasonId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomClosure_RoomId",
                table: "RoomClosure",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffAbsence_AbsenceTypeId",
                table: "StaffAbsence",
                column: "AbsenceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_StaffAbsence_IllnessTypeId",
                table: "StaffAbsence",
                column: "IllnessTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_StaffAbsence_StaffMemberId",
                table: "StaffAbsence",
