...
namespace MyPortal.Database.Models.Entity
{
    ...
    public class ExamSeason : BaseTypes.Entity
    {
        ...
        [Column(Order = 3)] public int CalendarYear { get; set; }
        ...
        [Column(Order = 6)] public string Name { get; set; }

        [Column(Order = 7)] public string Description { get; set; }

        [Column(Order = 8)] public bool Default { get; set; }
