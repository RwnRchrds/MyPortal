...
namespace MyPortal.Database.Models.Entity
{
    ...
    public class ExamSeatAllocation : BaseTypes.Entity, IActivatable
    {
        ...
        [Column(Order = 3)] public int SeatRow { get; set; }

        [Column(Order = 4)] public int SeatColumn { get; set; }

        [Column(Order = 5)] public Guid CandidateId { get; set; }

        [Column(Order = 6)] public bool Active { get; set; }

        [Column(Order = 7)] public bool Attended { get; set; }
