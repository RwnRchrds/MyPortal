...
namespace MyPortal.Database.Models.Entity
{
    ...
    public class LogNote : BaseTypes.Entity, ISoftDeleteEntity, ICreatable
    {
        ...
        [Column(Order = 4)] public Guid StudentId { get; set; }

        [Column(Order = 5)] public Guid AcademicYearId { get; set; }

        [Column(Order = 6)] [Required] public string Message { get; set; }

        [Column(Order = 7)] public DateTime CreatedDate { get; set; }

        // Only visible to staff users
        [Column(Order = 8)] public bool Private { get; set; }
