...
namespace MyPortal.Database.Models.Entity
{
    ...
    {
        [Column(Order = 2)] public Guid ClassId { get; set; }

        [Column(Order = 4)] public Guid TeacherId { get; set; }

        [Column(Order = 5)] public Guid? RoomId { get; set; }

        [Column(Order = 6, TypeName = "date")] public DateTime StartDate { get; set; }

        [Column(Order = 7, TypeName = "date")] public DateTime EndDate { get; set; }
