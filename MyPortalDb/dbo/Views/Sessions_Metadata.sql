...
AS
SELECT        S.Id AS SessionId, PAP.AttendanceWeekId, PAP.PeriodId, C.Id AS ClassId, C.GroupId AS CurriculumGroupId, PAP.StartTime, PAP.EndTime, P.Name AS PeriodName, C.Code AS ClassCode, CO.Description AS CourseDescription, 
